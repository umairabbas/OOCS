...
public enum Month {
	JANUARY(1, 31, "January"), FEBRUARY(2, 28, "February"), MARCH(3, 31, "March"), APRIL(4, 30, "April"), MAY(5, 31,
			"May"), JUNE(6, 30, "June"), JULY(7, 31, "July"), AUGUST(8, 31, "August"), SEPTEMBER(9, 30,
					"September"), OCTOBER(10, 31,
							"October"), NOVEMBER(11, 30, "November"), DECEMBER(12, 31, "December");
	 ...
	 * 
	 * @return The number corresponding to the month. (1 for January and 12 for
	 *         December)
	 */
	public int getValue() {
		return value;
	...
	/**
	 * OCL getNumberOfDays(int year) Assume that the year if positive or null
	 * 
	 * @pre 0 <= year
	 * 
	 * 
	 ...
	 * 
	 * @param year
	 *            The year in witch the month is
	 * @return the number of days corresponding to the month at this year
	 */
	...
	/**
	 * OCL Month month(int month) Assume that month is between 1(included) and
	 * 12(included)
	 * 
	 * @pre 0 < month < 13
	 * 
	 ...
	 * 
	 * @param month
	 *            The value of the month (1 for January and 12 for December)
	 ...
	 * 
	 * 
	 * Return the following month. Example: January -> February and December ->
	 * January
	 * 
